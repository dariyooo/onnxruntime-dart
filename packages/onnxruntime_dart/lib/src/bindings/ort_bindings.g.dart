...
//
// Generated by package:ffigen from the ORT submodule pinned in
// third_party/onnxruntime. Regenerate with `dart run ffigen`.
//
// ignore_for_file: type=lint, camel_case_types, non_constant_identifier_names
// ignore_for_file: unused_field, unused_element, doc_directive_unknown
...
/// Generated ONNX Runtime C API bindings (ORT_API_VERSION 29).
class OrtBindings {
...
final class OrtAllocator extends ffi.Struct {
  ...
  static ffi.Pointer<OrtAllocator> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(
                    ffi.Pointer<OrtAllocator> this_, ffi.Size size)>>
        Alloc,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<OrtAllocator> this_, ffi.Pointer<ffi.Void> p)>>
        Free,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<OrtMemoryInfo> Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<OrtAllocator> this_,
                    ffi.Size size, ffi.Pointer<OrtSyncStream> stream)>>
        AllocOnStream,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtAllocator> this_)>>
      ...
      $allocator<OrtAllocator>()
        ...
        ..ref.Info = Info
        ..ref.Reserve = Reserve
        ..ref.GetStats = GetStats
        ..ref.AllocOnStream = AllocOnStream
        ..ref.Shrink = Shrink;
}
...
final class OrtApi extends ffi.Struct {
  ...
  external ffi.Pointer<
          ffi.NativeFunction<
              OrtExperimentalFnPtr Function(ffi.Pointer<ffi.Char> name)>>
  ...
  static ffi.Pointer<OrtApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<OrtStatus> Function(
                    ffi.UnsignedInt code, ffi.Pointer<ffi.Char> msg)>>
        CreateStatus,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.UnsignedInt Function(ffi.Pointer<OrtStatus> status)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> value,
                    ffi.Pointer<ffi.Pointer<ffi.Char>> s, ffi.Size s_len)>>
        FillStringTensor,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtAllocator> ort_allocator,
                    ffi.Size size, ffi.Pointer<ffi.Pointer<ffi.Void>> out)>>
        AllocatorAlloc,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtAllocator> ort_allocator,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtSessionOptions> options,
                    ffi.Pointer<ffi.Char> dim_denotation, ffi.Int64 dim_value)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelInfo> info,
                    ffi.Pointer<ffi.Char> name, ffi.Pointer<ffi.Float> out)>>
        KernelInfoGetAttribute_float,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelInfo> info,
                    ffi.Pointer<ffi.Char> name, ffi.Pointer<ffi.Int64> out)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelContext> context,
                    ffi.Size index, ffi.Pointer<ffi.Pointer<OrtValue>> out)>>
    ...
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<OrtSession> input)>>
        ReleaseSession,
    required ffi.Pointer<
            ffi.NativeFunction<ffi.Void Function(ffi.Pointer<OrtValue> input)>>
        ReleaseValue,
    ...
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<OrtTypeInfo> input)>>
        ReleaseTypeInfo,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtSessionOptions> options,
                    ffi.Pointer<ffi.Char> dim_name, ffi.Int64 dim_value)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> value,
                    ffi.Size index, ffi.Pointer<ffi.Size> out)>>
        GetStringTensorElementLength,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> value,
                    ffi.Size s_len, ffi.Size index, ffi.Pointer<ffi.Void> s)>>
        GetStringTensorElement,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> value,
                    ffi.Pointer<ffi.Char> s, ffi.Size index)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtIoBinding> binding_ptr,
                    ffi.Pointer<ffi.Char> name, ffi.Pointer<OrtValue> val_ptr)>>
        BindInput,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtIoBinding> binding_ptr,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtSessionOptions> options,
                    ffi.Pointer<ffi.Char> name, ffi.Pointer<OrtValue> val)>>
        AddInitializer,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<OrtArenaCfg> input)>>
        ReleaseArenaCfg,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<ffi.Pointer<OrtPrepackedWeightsContainer>>
                        out)>>
        CreatePrepackedWeightsContainer,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtSessionOptions> options,
                    ffi.Pointer<OrtTensorRTProviderOptionsV2>
                        tensorrt_options)>>
        SessionOptionsAppendExecutionProvider_TensorRT_V2,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<ffi.Pointer<OrtTensorRTProviderOptionsV2>>
                        out)>>
        CreateTensorRTProviderOptions,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> ort_value,
                    ffi.Pointer<ffi.Int64> indices_data, ffi.Size indices_num)>>
        UseCooIndices,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelInfo> info,
                    ffi.Pointer<ffi.Char> out, ffi.Pointer<ffi.Size> size)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<ffi.Pointer<OrtAllocator>> out)>>
        KernelContext_GetAllocator,
    required ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>
        GetBuildInfoString,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<OrtLoraAdapter> input)>>
        ReleaseLoraAdapter,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtRunOptions> options,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtEnv> env,
                    ffi.Pointer<ffi.Pointer<ffi.Pointer<OrtEpDevice>>>
                        ep_devices,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<OrtHardwareDevice> Function(
                    ffi.Pointer<OrtEpDevice> ep_device)>>
        EpDevice_Device,
    required ffi.Pointer<ffi.NativeFunction<ffi.Pointer<OrtEpApi> Function()>>
        GetEpApi,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtValue> ort_value,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Uint32 Function(ffi.Pointer<OrtMemoryInfo> ptr)>>
        MemoryInfoGetVendorId,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<OrtExternalInitializerInfo> input)>>
        ReleaseExternalInitializerInfo,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Char> Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<OrtSyncStream> input)>>
        ReleaseSyncStream,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtEpAssignedSubgraph> ep_subgraph,
                    ffi.Pointer<ffi.Pointer<ffi.Pointer<OrtEpAssignedNode>>>
                        ep_nodes,
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtApi>()
        ..ref.CreateStatus = CreateStatus
        ..ref.GetErrorCode = GetErrorCode
        ..ref.GetErrorMessage = GetErrorMessage
        ..ref.CreateEnv = CreateEnv
        ..ref.CreateEnvWithCustomLogger = CreateEnvWithCustomLogger
        ..ref.EnableTelemetryEvents = EnableTelemetryEvents
        ..ref.DisableTelemetryEvents = DisableTelemetryEvents
        ..ref.CreateSession = CreateSession
        ..ref.CreateSessionFromArray = CreateSessionFromArray
        ..ref.Run = Run
        ..ref.CreateSessionOptions = CreateSessionOptions
        ..ref.SetOptimizedModelFilePath = SetOptimizedModelFilePath
        ..ref.CloneSessionOptions = CloneSessionOptions
        ..ref.SetSessionExecutionMode = SetSessionExecutionMode
        ..ref.EnableProfiling = EnableProfiling
        ..ref.DisableProfiling = DisableProfiling
        ..ref.EnableMemPattern = EnableMemPattern
        ..ref.DisableMemPattern = DisableMemPattern
        ..ref.EnableCpuMemArena = EnableCpuMemArena
        ..ref.DisableCpuMemArena = DisableCpuMemArena
        ..ref.SetSessionLogId = SetSessionLogId
        ..ref.SetSessionLogVerbosityLevel = SetSessionLogVerbosityLevel
        ..ref.SetSessionLogSeverityLevel = SetSessionLogSeverityLevel
        ..ref.SetSessionGraphOptimizationLevel =
            SetSessionGraphOptimizationLevel
        ..ref.SetIntraOpNumThreads = SetIntraOpNumThreads
        ..ref.SetInterOpNumThreads = SetInterOpNumThreads
        ..ref.CreateCustomOpDomain = CreateCustomOpDomain
        ..ref.CustomOpDomain_Add = CustomOpDomain_Add
        ..ref.AddCustomOpDomain = AddCustomOpDomain
        ..ref.RegisterCustomOpsLibrary = RegisterCustomOpsLibrary
        ..ref.SessionGetInputCount = SessionGetInputCount
        ..ref.SessionGetOutputCount = SessionGetOutputCount
        ..ref.SessionGetOverridableInitializerCount =
            SessionGetOverridableInitializerCount
        ..ref.SessionGetInputTypeInfo = SessionGetInputTypeInfo
        ..ref.SessionGetOutputTypeInfo = SessionGetOutputTypeInfo
        ..ref.SessionGetOverridableInitializerTypeInfo =
            SessionGetOverridableInitializerTypeInfo
        ..ref.SessionGetInputName = SessionGetInputName
        ..ref.SessionGetOutputName = SessionGetOutputName
        ..ref.SessionGetOverridableInitializerName =
            SessionGetOverridableInitializerName
        ..ref.CreateRunOptions = CreateRunOptions
        ..ref.RunOptionsSetRunLogVerbosityLevel =
            RunOptionsSetRunLogVerbosityLevel
        ..ref.RunOptionsSetRunLogSeverityLevel =
            RunOptionsSetRunLogSeverityLevel
        ..ref.RunOptionsSetRunTag = RunOptionsSetRunTag
        ..ref.RunOptionsGetRunLogVerbosityLevel =
            RunOptionsGetRunLogVerbosityLevel
        ..ref.RunOptionsGetRunLogSeverityLevel =
            RunOptionsGetRunLogSeverityLevel
        ..ref.RunOptionsGetRunTag = RunOptionsGetRunTag
        ..ref.RunOptionsSetTerminate = RunOptionsSetTerminate
        ..ref.RunOptionsUnsetTerminate = RunOptionsUnsetTerminate
        ..ref.CreateTensorAsOrtValue = CreateTensorAsOrtValue
        ..ref.CreateTensorWithDataAsOrtValue = CreateTensorWithDataAsOrtValue
        ..ref.IsTensor = IsTensor
        ..ref.GetTensorMutableData = GetTensorMutableData
        ..ref.FillStringTensor = FillStringTensor
        ..ref.GetStringTensorDataLength = GetStringTensorDataLength
        ..ref.GetStringTensorContent = GetStringTensorContent
        ..ref.CastTypeInfoToTensorInfo = CastTypeInfoToTensorInfo
        ..ref.GetOnnxTypeFromTypeInfo = GetOnnxTypeFromTypeInfo
        ..ref.CreateTensorTypeAndShapeInfo = CreateTensorTypeAndShapeInfo
        ..ref.SetTensorElementType = SetTensorElementType
        ..ref.SetDimensions = SetDimensions
        ..ref.GetTensorElementType = GetTensorElementType
        ..ref.GetDimensionsCount = GetDimensionsCount
        ..ref.GetDimensions = GetDimensions
        ..ref.GetSymbolicDimensions = GetSymbolicDimensions
        ..ref.GetTensorShapeElementCount = GetTensorShapeElementCount
        ..ref.GetTensorTypeAndShape = GetTensorTypeAndShape
        ..ref.GetTypeInfo = GetTypeInfo
        ..ref.GetValueType = GetValueType
        ..ref.CreateMemoryInfo = CreateMemoryInfo
        ..ref.CreateCpuMemoryInfo = CreateCpuMemoryInfo
        ..ref.CompareMemoryInfo = CompareMemoryInfo
        ..ref.MemoryInfoGetName = MemoryInfoGetName
        ..ref.MemoryInfoGetId = MemoryInfoGetId
        ..ref.MemoryInfoGetMemType = MemoryInfoGetMemType
        ..ref.MemoryInfoGetType = MemoryInfoGetType
        ..ref.AllocatorAlloc = AllocatorAlloc
        ..ref.AllocatorFree = AllocatorFree
        ..ref.AllocatorGetInfo = AllocatorGetInfo
        ..ref.GetAllocatorWithDefaultOptions = GetAllocatorWithDefaultOptions
        ..ref.AddFreeDimensionOverride = AddFreeDimensionOverride
        ..ref.GetValue = GetValue
        ..ref.GetValueCount = GetValueCount
        ..ref.CreateValue = CreateValue
        ..ref.CreateOpaqueValue = CreateOpaqueValue
        ..ref.GetOpaqueValue = GetOpaqueValue
        ..ref.KernelInfoGetAttribute_float = KernelInfoGetAttribute_float
        ..ref.KernelInfoGetAttribute_int64 = KernelInfoGetAttribute_int64
        ..ref.KernelInfoGetAttribute_string = KernelInfoGetAttribute_string
        ..ref.KernelContext_GetInputCount = KernelContext_GetInputCount
        ..ref.KernelContext_GetOutputCount = KernelContext_GetOutputCount
        ..ref.KernelContext_GetInput = KernelContext_GetInput
        ..ref.KernelContext_GetOutput = KernelContext_GetOutput
        ..ref.ReleaseEnv = ReleaseEnv
        ..ref.ReleaseStatus = ReleaseStatus
        ..ref.ReleaseMemoryInfo = ReleaseMemoryInfo
        ..ref.ReleaseSession = ReleaseSession
        ..ref.ReleaseValue = ReleaseValue
        ..ref.ReleaseRunOptions = ReleaseRunOptions
        ..ref.ReleaseTypeInfo = ReleaseTypeInfo
        ..ref.ReleaseTensorTypeAndShapeInfo = ReleaseTensorTypeAndShapeInfo
        ..ref.ReleaseSessionOptions = ReleaseSessionOptions
        ..ref.ReleaseCustomOpDomain = ReleaseCustomOpDomain
        ..ref.GetDenotationFromTypeInfo = GetDenotationFromTypeInfo
        ..ref.CastTypeInfoToMapTypeInfo = CastTypeInfoToMapTypeInfo
        ..ref.CastTypeInfoToSequenceTypeInfo = CastTypeInfoToSequenceTypeInfo
        ..ref.GetMapKeyType = GetMapKeyType
        ..ref.GetMapValueType = GetMapValueType
        ..ref.GetSequenceElementType = GetSequenceElementType
        ..ref.ReleaseMapTypeInfo = ReleaseMapTypeInfo
        ..ref.ReleaseSequenceTypeInfo = ReleaseSequenceTypeInfo
        ..ref.SessionEndProfiling = SessionEndProfiling
        ..ref.SessionGetModelMetadata = SessionGetModelMetadata
        ..ref.ModelMetadataGetProducerName = ModelMetadataGetProducerName
        ..ref.ModelMetadataGetGraphName = ModelMetadataGetGraphName
        ..ref.ModelMetadataGetDomain = ModelMetadataGetDomain
        ..ref.ModelMetadataGetDescription = ModelMetadataGetDescription
        ..ref.ModelMetadataLookupCustomMetadataMap =
            ModelMetadataLookupCustomMetadataMap
        ..ref.ModelMetadataGetVersion = ModelMetadataGetVersion
        ..ref.ReleaseModelMetadata = ReleaseModelMetadata
        ..ref.CreateEnvWithGlobalThreadPools = CreateEnvWithGlobalThreadPools
        ..ref.DisablePerSessionThreads = DisablePerSessionThreads
        ..ref.CreateThreadingOptions = CreateThreadingOptions
        ..ref.ReleaseThreadingOptions = ReleaseThreadingOptions
        ..ref.ModelMetadataGetCustomMetadataMapKeys =
            ModelMetadataGetCustomMetadataMapKeys
        ..ref.AddFreeDimensionOverrideByName = AddFreeDimensionOverrideByName
        ..ref.GetAvailableProviders = GetAvailableProviders
        ..ref.ReleaseAvailableProviders = ReleaseAvailableProviders
        ..ref.GetStringTensorElementLength = GetStringTensorElementLength
        ..ref.GetStringTensorElement = GetStringTensorElement
        ..ref.FillStringTensorElement = FillStringTensorElement
        ..ref.AddSessionConfigEntry = AddSessionConfigEntry
        ..ref.CreateAllocator = CreateAllocator
        ..ref.ReleaseAllocator = ReleaseAllocator
        ..ref.RunWithBinding = RunWithBinding
        ..ref.CreateIoBinding = CreateIoBinding
        ..ref.ReleaseIoBinding = ReleaseIoBinding
        ..ref.BindInput = BindInput
        ..ref.BindOutput = BindOutput
        ..ref.BindOutputToDevice = BindOutputToDevice
        ..ref.GetBoundOutputNames = GetBoundOutputNames
        ..ref.GetBoundOutputValues = GetBoundOutputValues
        ..ref.ClearBoundInputs = ClearBoundInputs
        ..ref.ClearBoundOutputs = ClearBoundOutputs
        ..ref.TensorAt = TensorAt
        ..ref.CreateAndRegisterAllocator = CreateAndRegisterAllocator
        ..ref.SetLanguageProjection = SetLanguageProjection
        ..ref.SessionGetProfilingStartTimeNs = SessionGetProfilingStartTimeNs
        ..ref.SetGlobalIntraOpNumThreads = SetGlobalIntraOpNumThreads
        ..ref.SetGlobalInterOpNumThreads = SetGlobalInterOpNumThreads
        ..ref.SetGlobalSpinControl = SetGlobalSpinControl
        ..ref.AddInitializer = AddInitializer
        ..ref.CreateEnvWithCustomLoggerAndGlobalThreadPools =
            CreateEnvWithCustomLoggerAndGlobalThreadPools
        ..ref.SessionOptionsAppendExecutionProvider_CUDA =
            SessionOptionsAppendExecutionProvider_CUDA
        ..ref.SessionOptionsAppendExecutionProvider_ROCM =
            SessionOptionsAppendExecutionProvider_ROCM
        ..ref.SessionOptionsAppendExecutionProvider_OpenVINO =
            SessionOptionsAppendExecutionProvider_OpenVINO
        ..ref.SetGlobalDenormalAsZero = SetGlobalDenormalAsZero
        ..ref.CreateArenaCfg = CreateArenaCfg
        ..ref.ReleaseArenaCfg = ReleaseArenaCfg
        ..ref.ModelMetadataGetGraphDescription =
            ModelMetadataGetGraphDescription
        ..ref.SessionOptionsAppendExecutionProvider_TensorRT =
            SessionOptionsAppendExecutionProvider_TensorRT
        ..ref.SetCurrentGpuDeviceId = SetCurrentGpuDeviceId
        ..ref.GetCurrentGpuDeviceId = GetCurrentGpuDeviceId
        ..ref.KernelInfoGetAttributeArray_float =
            KernelInfoGetAttributeArray_float
        ..ref.KernelInfoGetAttributeArray_int64 =
            KernelInfoGetAttributeArray_int64
        ..ref.CreateArenaCfgV2 = CreateArenaCfgV2
        ..ref.AddRunConfigEntry = AddRunConfigEntry
        ..ref.CreatePrepackedWeightsContainer = CreatePrepackedWeightsContainer
        ..ref.ReleasePrepackedWeightsContainer =
            ReleasePrepackedWeightsContainer
        ..ref.CreateSessionWithPrepackedWeightsContainer =
            CreateSessionWithPrepackedWeightsContainer
        ..ref.CreateSessionFromArrayWithPrepackedWeightsContainer =
            CreateSessionFromArrayWithPrepackedWeightsContainer
        ..ref.SessionOptionsAppendExecutionProvider_TensorRT_V2 =
            SessionOptionsAppendExecutionProvider_TensorRT_V2
        ..ref.CreateTensorRTProviderOptions = CreateTensorRTProviderOptions
        ..ref.UpdateTensorRTProviderOptions = UpdateTensorRTProviderOptions
        ..ref.GetTensorRTProviderOptionsAsString =
            GetTensorRTProviderOptionsAsString
        ..ref.ReleaseTensorRTProviderOptions = ReleaseTensorRTProviderOptions
        ..ref.EnableOrtCustomOps = EnableOrtCustomOps
        ..ref.RegisterAllocator = RegisterAllocator
        ..ref.UnregisterAllocator = UnregisterAllocator
        ..ref.IsSparseTensor = IsSparseTensor
        ..ref.CreateSparseTensorAsOrtValue = CreateSparseTensorAsOrtValue
        ..ref.FillSparseTensorCoo = FillSparseTensorCoo
        ..ref.FillSparseTensorCsr = FillSparseTensorCsr
        ..ref.FillSparseTensorBlockSparse = FillSparseTensorBlockSparse
        ..ref.CreateSparseTensorWithValuesAsOrtValue =
            CreateSparseTensorWithValuesAsOrtValue
        ..ref.UseCooIndices = UseCooIndices
        ..ref.UseCsrIndices = UseCsrIndices
        ..ref.UseBlockSparseIndices = UseBlockSparseIndices
        ..ref.GetSparseTensorFormat = GetSparseTensorFormat
        ..ref.GetSparseTensorValuesTypeAndShape =
            GetSparseTensorValuesTypeAndShape
        ..ref.GetSparseTensorValues = GetSparseTensorValues
        ..ref.GetSparseTensorIndicesTypeShape = GetSparseTensorIndicesTypeShape
        ..ref.GetSparseTensorIndices = GetSparseTensorIndices
        ..ref.HasValue = HasValue
        ..ref.KernelContext_GetGPUComputeStream =
            KernelContext_GetGPUComputeStream
        ..ref.GetTensorMemoryInfo = GetTensorMemoryInfo
        ..ref.GetExecutionProviderApi = GetExecutionProviderApi
        ..ref.SessionOptionsSetCustomCreateThreadFn =
            SessionOptionsSetCustomCreateThreadFn
        ..ref.SessionOptionsSetCustomThreadCreationOptions =
            SessionOptionsSetCustomThreadCreationOptions
        ..ref.SessionOptionsSetCustomJoinThreadFn =
            SessionOptionsSetCustomJoinThreadFn
        ..ref.SetGlobalCustomCreateThreadFn = SetGlobalCustomCreateThreadFn
        ..ref.SetGlobalCustomThreadCreationOptions =
            SetGlobalCustomThreadCreationOptions
        ..ref.SetGlobalCustomJoinThreadFn = SetGlobalCustomJoinThreadFn
        ..ref.SynchronizeBoundInputs = SynchronizeBoundInputs
        ..ref.SynchronizeBoundOutputs = SynchronizeBoundOutputs
        ..ref.SessionOptionsAppendExecutionProvider_CUDA_V2 =
            SessionOptionsAppendExecutionProvider_CUDA_V2
        ..ref.CreateCUDAProviderOptions = CreateCUDAProviderOptions
        ..ref.UpdateCUDAProviderOptions = UpdateCUDAProviderOptions
        ..ref.GetCUDAProviderOptionsAsString = GetCUDAProviderOptionsAsString
        ..ref.ReleaseCUDAProviderOptions = ReleaseCUDAProviderOptions
        ..ref.SessionOptionsAppendExecutionProvider_MIGraphX =
            SessionOptionsAppendExecutionProvider_MIGraphX
        ..ref.AddExternalInitializers = AddExternalInitializers
        ..ref.CreateOpAttr = CreateOpAttr
        ..ref.ReleaseOpAttr = ReleaseOpAttr
        ..ref.CreateOp = CreateOp
        ..ref.InvokeOp = InvokeOp
        ..ref.ReleaseOp = ReleaseOp
        ..ref.SessionOptionsAppendExecutionProvider =
            SessionOptionsAppendExecutionProvider
        ..ref.CopyKernelInfo = CopyKernelInfo
        ..ref.ReleaseKernelInfo = ReleaseKernelInfo
        ..ref.GetTrainingApi = GetTrainingApi
        ..ref.SessionOptionsAppendExecutionProvider_CANN =
            SessionOptionsAppendExecutionProvider_CANN
        ..ref.CreateCANNProviderOptions = CreateCANNProviderOptions
        ..ref.UpdateCANNProviderOptions = UpdateCANNProviderOptions
        ..ref.GetCANNProviderOptionsAsString = GetCANNProviderOptionsAsString
        ..ref.ReleaseCANNProviderOptions = ReleaseCANNProviderOptions
        ..ref.MemoryInfoGetDeviceType = MemoryInfoGetDeviceType
        ..ref.UpdateEnvWithCustomLogLevel = UpdateEnvWithCustomLogLevel
        ..ref.SetGlobalIntraOpThreadAffinity = SetGlobalIntraOpThreadAffinity
        ..ref.RegisterCustomOpsLibrary_V2 = RegisterCustomOpsLibrary_V2
        ..ref.RegisterCustomOpsUsingFunction = RegisterCustomOpsUsingFunction
        ..ref.KernelInfo_GetInputCount = KernelInfo_GetInputCount
        ..ref.KernelInfo_GetOutputCount = KernelInfo_GetOutputCount
        ..ref.KernelInfo_GetInputName = KernelInfo_GetInputName
        ..ref.KernelInfo_GetOutputName = KernelInfo_GetOutputName
        ..ref.KernelInfo_GetInputTypeInfo = KernelInfo_GetInputTypeInfo
        ..ref.KernelInfo_GetOutputTypeInfo = KernelInfo_GetOutputTypeInfo
        ..ref.KernelInfoGetAttribute_tensor = KernelInfoGetAttribute_tensor
        ..ref.HasSessionConfigEntry = HasSessionConfigEntry
        ..ref.GetSessionConfigEntry = GetSessionConfigEntry
        ..ref.SessionOptionsAppendExecutionProvider_Dnnl =
            SessionOptionsAppendExecutionProvider_Dnnl
        ..ref.CreateDnnlProviderOptions = CreateDnnlProviderOptions
        ..ref.UpdateDnnlProviderOptions = UpdateDnnlProviderOptions
        ..ref.GetDnnlProviderOptionsAsString = GetDnnlProviderOptionsAsString
        ..ref.ReleaseDnnlProviderOptions = ReleaseDnnlProviderOptions
        ..ref.KernelInfo_GetNodeName = KernelInfo_GetNodeName
        ..ref.KernelInfo_GetLogger = KernelInfo_GetLogger
        ..ref.KernelContext_GetLogger = KernelContext_GetLogger
        ..ref.Logger_LogMessage = Logger_LogMessage
        ..ref.Logger_GetLoggingSeverityLevel = Logger_GetLoggingSeverityLevel
        ..ref.KernelInfoGetConstantInput_tensor =
            KernelInfoGetConstantInput_tensor
        ..ref.CastTypeInfoToOptionalTypeInfo = CastTypeInfoToOptionalTypeInfo
        ..ref.GetOptionalContainedTypeInfo = GetOptionalContainedTypeInfo
        ..ref.GetResizedStringTensorElementBuffer =
            GetResizedStringTensorElementBuffer
        ..ref.KernelContext_GetAllocator = KernelContext_GetAllocator
        ..ref.GetBuildInfoString = GetBuildInfoString
        ..ref.CreateROCMProviderOptions = CreateROCMProviderOptions
        ..ref.UpdateROCMProviderOptions = UpdateROCMProviderOptions
        ..ref.GetROCMProviderOptionsAsString = GetROCMProviderOptionsAsString
        ..ref.ReleaseROCMProviderOptions = ReleaseROCMProviderOptions
        ..ref.CreateAndRegisterAllocatorV2 = CreateAndRegisterAllocatorV2
        ..ref.RunAsync = RunAsync
        ..ref.UpdateTensorRTProviderOptionsWithValue =
            UpdateTensorRTProviderOptionsWithValue
        ..ref.GetTensorRTProviderOptionsByName =
            GetTensorRTProviderOptionsByName
        ..ref.UpdateCUDAProviderOptionsWithValue =
            UpdateCUDAProviderOptionsWithValue
        ..ref.GetCUDAProviderOptionsByName = GetCUDAProviderOptionsByName
        ..ref.KernelContext_GetResource = KernelContext_GetResource
        ..ref.SetUserLoggingFunction = SetUserLoggingFunction
        ..ref.ShapeInferContext_GetInputCount = ShapeInferContext_GetInputCount
        ..ref.ShapeInferContext_GetInputTypeShape =
            ShapeInferContext_GetInputTypeShape
        ..ref.ShapeInferContext_GetAttribute = ShapeInferContext_GetAttribute
        ..ref.ShapeInferContext_SetOutputTypeShape =
            ShapeInferContext_SetOutputTypeShape
        ..ref.SetSymbolicDimensions = SetSymbolicDimensions
        ..ref.ReadOpAttr = ReadOpAttr
        ..ref.SetDeterministicCompute = SetDeterministicCompute
        ..ref.KernelContext_ParallelFor = KernelContext_ParallelFor
        ..ref.SessionOptionsAppendExecutionProvider_OpenVINO_V2 =
            SessionOptionsAppendExecutionProvider_OpenVINO_V2
        ..ref.SessionOptionsAppendExecutionProvider_VitisAI =
            SessionOptionsAppendExecutionProvider_VitisAI
        ..ref.KernelContext_GetScratchBuffer = KernelContext_GetScratchBuffer
        ..ref.KernelInfoGetAllocator = KernelInfoGetAllocator
        ..ref.AddExternalInitializersFromFilesInMemory =
            AddExternalInitializersFromFilesInMemory
        ..ref.CreateLoraAdapter = CreateLoraAdapter
        ..ref.CreateLoraAdapterFromArray = CreateLoraAdapterFromArray
        ..ref.ReleaseLoraAdapter = ReleaseLoraAdapter
        ..ref.RunOptionsAddActiveLoraAdapter = RunOptionsAddActiveLoraAdapter
        ..ref.SetEpDynamicOptions = SetEpDynamicOptions
        ..ref.ReleaseValueInfo = ReleaseValueInfo
        ..ref.ReleaseNode = ReleaseNode
        ..ref.ReleaseGraph = ReleaseGraph
        ..ref.ReleaseModel = ReleaseModel
        ..ref.GetValueInfoName = GetValueInfoName
        ..ref.GetValueInfoTypeInfo = GetValueInfoTypeInfo
        ..ref.GetModelEditorApi = GetModelEditorApi
        ..ref.CreateTensorWithDataAndDeleterAsOrtValue =
            CreateTensorWithDataAndDeleterAsOrtValue
        ..ref.SessionOptionsSetLoadCancellationFlag =
            SessionOptionsSetLoadCancellationFlag
        ..ref.GetCompileApi = GetCompileApi
        ..ref.CreateKeyValuePairs = CreateKeyValuePairs
        ..ref.AddKeyValuePair = AddKeyValuePair
        ..ref.GetKeyValue = GetKeyValue
        ..ref.GetKeyValuePairs = GetKeyValuePairs
        ..ref.RemoveKeyValuePair = RemoveKeyValuePair
        ..ref.ReleaseKeyValuePairs = ReleaseKeyValuePairs
        ..ref.RegisterExecutionProviderLibrary =
            RegisterExecutionProviderLibrary
        ..ref.UnregisterExecutionProviderLibrary =
            UnregisterExecutionProviderLibrary
        ..ref.GetEpDevices = GetEpDevices
        ..ref.SessionOptionsAppendExecutionProvider_V2 =
            SessionOptionsAppendExecutionProvider_V2
        ..ref.SessionOptionsSetEpSelectionPolicy =
            SessionOptionsSetEpSelectionPolicy
        ..ref.SessionOptionsSetEpSelectionPolicyDelegate =
            SessionOptionsSetEpSelectionPolicyDelegate
        ..ref.HardwareDevice_Type = HardwareDevice_Type
        ..ref.HardwareDevice_VendorId = HardwareDevice_VendorId
        ..ref.HardwareDevice_Vendor = HardwareDevice_Vendor
        ..ref.HardwareDevice_DeviceId = HardwareDevice_DeviceId
        ..ref.HardwareDevice_Metadata = HardwareDevice_Metadata
        ..ref.EpDevice_EpName = EpDevice_EpName
        ..ref.EpDevice_EpVendor = EpDevice_EpVendor
        ..ref.EpDevice_EpMetadata = EpDevice_EpMetadata
        ..ref.EpDevice_EpOptions = EpDevice_EpOptions
        ..ref.EpDevice_Device = EpDevice_Device
        ..ref.GetEpApi = GetEpApi
        ..ref.GetTensorSizeInBytes = GetTensorSizeInBytes
        ..ref.AllocatorGetStats = AllocatorGetStats
        ..ref.CreateMemoryInfo_V2 = CreateMemoryInfo_V2
        ..ref.MemoryInfoGetDeviceMemType = MemoryInfoGetDeviceMemType
        ..ref.MemoryInfoGetVendorId = MemoryInfoGetVendorId
        ..ref.ValueInfo_GetValueProducer = ValueInfo_GetValueProducer
        ..ref.ValueInfo_GetValueNumConsumers = ValueInfo_GetValueNumConsumers
        ..ref.ValueInfo_GetValueConsumers = ValueInfo_GetValueConsumers
        ..ref.ValueInfo_GetInitializerValue = ValueInfo_GetInitializerValue
        ..ref.ValueInfo_GetExternalInitializerInfo =
            ValueInfo_GetExternalInitializerInfo
        ..ref.ValueInfo_IsRequiredGraphInput = ValueInfo_IsRequiredGraphInput
        ..ref.ValueInfo_IsOptionalGraphInput = ValueInfo_IsOptionalGraphInput
        ..ref.ValueInfo_IsGraphOutput = ValueInfo_IsGraphOutput
        ..ref.ValueInfo_IsConstantInitializer = ValueInfo_IsConstantInitializer
        ..ref.ValueInfo_IsFromOuterScope = ValueInfo_IsFromOuterScope
        ..ref.Graph_GetName = Graph_GetName
        ..ref.Graph_GetModelPath = Graph_GetModelPath
        ..ref.Graph_GetOnnxIRVersion = Graph_GetOnnxIRVersion
        ..ref.Graph_GetNumOperatorSets = Graph_GetNumOperatorSets
        ..ref.Graph_GetOperatorSets = Graph_GetOperatorSets
        ..ref.Graph_GetNumInputs = Graph_GetNumInputs
        ..ref.Graph_GetInputs = Graph_GetInputs
        ..ref.Graph_GetNumOutputs = Graph_GetNumOutputs
        ..ref.Graph_GetOutputs = Graph_GetOutputs
        ..ref.Graph_GetNumInitializers = Graph_GetNumInitializers
        ..ref.Graph_GetInitializers = Graph_GetInitializers
        ..ref.Graph_GetNumNodes = Graph_GetNumNodes
        ..ref.Graph_GetNodes = Graph_GetNodes
        ..ref.Graph_GetParentNode = Graph_GetParentNode
        ..ref.Graph_GetGraphView = Graph_GetGraphView
        ..ref.Node_GetId = Node_GetId
        ..ref.Node_GetName = Node_GetName
        ..ref.Node_GetOperatorType = Node_GetOperatorType
        ..ref.Node_GetDomain = Node_GetDomain
        ..ref.Node_GetSinceVersion = Node_GetSinceVersion
        ..ref.Node_GetNumInputs = Node_GetNumInputs
        ..ref.Node_GetInputs = Node_GetInputs
        ..ref.Node_GetNumOutputs = Node_GetNumOutputs
        ..ref.Node_GetOutputs = Node_GetOutputs
        ..ref.Node_GetNumImplicitInputs = Node_GetNumImplicitInputs
        ..ref.Node_GetImplicitInputs = Node_GetImplicitInputs
        ..ref.Node_GetNumAttributes = Node_GetNumAttributes
        ..ref.Node_GetAttributes = Node_GetAttributes
        ..ref.Node_GetAttributeByName = Node_GetAttributeByName
        ..ref.OpAttr_GetTensorAttributeAsOrtValue =
            OpAttr_GetTensorAttributeAsOrtValue
        ..ref.OpAttr_GetType = OpAttr_GetType
        ..ref.OpAttr_GetName = OpAttr_GetName
        ..ref.Node_GetNumSubgraphs = Node_GetNumSubgraphs
        ..ref.Node_GetSubgraphs = Node_GetSubgraphs
        ..ref.Node_GetGraph = Node_GetGraph
        ..ref.Node_GetEpName = Node_GetEpName
        ..ref.ReleaseExternalInitializerInfo = ReleaseExternalInitializerInfo
        ..ref.ExternalInitializerInfo_GetFilePath =
            ExternalInitializerInfo_GetFilePath
        ..ref.ExternalInitializerInfo_GetFileOffset =
            ExternalInitializerInfo_GetFileOffset
        ..ref.ExternalInitializerInfo_GetByteSize =
            ExternalInitializerInfo_GetByteSize
        ..ref.GetRunConfigEntry = GetRunConfigEntry
        ..ref.EpDevice_MemoryInfo = EpDevice_MemoryInfo
        ..ref.CreateSharedAllocator = CreateSharedAllocator
        ..ref.GetSharedAllocator = GetSharedAllocator
        ..ref.ReleaseSharedAllocator = ReleaseSharedAllocator
        ..ref.GetTensorData = GetTensorData
        ..ref.GetSessionOptionsConfigEntries = GetSessionOptionsConfigEntries
        ..ref.SessionGetMemoryInfoForInputs = SessionGetMemoryInfoForInputs
        ..ref.SessionGetMemoryInfoForOutputs = SessionGetMemoryInfoForOutputs
        ..ref.SessionGetEpDeviceForInputs = SessionGetEpDeviceForInputs
        ..ref.CreateSyncStreamForEpDevice = CreateSyncStreamForEpDevice
        ..ref.SyncStream_GetHandle = SyncStream_GetHandle
        ..ref.ReleaseSyncStream = ReleaseSyncStream
        ..ref.CopyTensors = CopyTensors
        ..ref.Graph_GetModelMetadata = Graph_GetModelMetadata
        ..ref.GetModelCompatibilityForEpDevices =
            GetModelCompatibilityForEpDevices
        ..ref.CreateExternalInitializerInfo = CreateExternalInitializerInfo
        ..ref.TensorTypeAndShape_HasShape = TensorTypeAndShape_HasShape
        ..ref.KernelInfo_GetConfigEntries = KernelInfo_GetConfigEntries
        ..ref.KernelInfo_GetOperatorDomain = KernelInfo_GetOperatorDomain
        ..ref.KernelInfo_GetOperatorType = KernelInfo_GetOperatorType
        ..ref.KernelInfo_GetOperatorSinceVersion =
            KernelInfo_GetOperatorSinceVersion
        ..ref.GetInteropApi = GetInteropApi
        ..ref.SessionGetEpDeviceForOutputs = SessionGetEpDeviceForOutputs
        ..ref.GetNumHardwareDevices = GetNumHardwareDevices
        ..ref.GetHardwareDevices = GetHardwareDevices
        ..ref.GetHardwareDeviceEpIncompatibilityDetails =
            GetHardwareDeviceEpIncompatibilityDetails
        ..ref.DeviceEpIncompatibilityDetails_GetReasonsBitmask =
            DeviceEpIncompatibilityDetails_GetReasonsBitmask
        ..ref.DeviceEpIncompatibilityDetails_GetNotes =
            DeviceEpIncompatibilityDetails_GetNotes
        ..ref.DeviceEpIncompatibilityDetails_GetErrorCode =
            DeviceEpIncompatibilityDetails_GetErrorCode
        ..ref.ReleaseDeviceEpIncompatibilityDetails =
            ReleaseDeviceEpIncompatibilityDetails
        ..ref.GetCompatibilityInfoFromModel = GetCompatibilityInfoFromModel
        ..ref.GetCompatibilityInfoFromModelBytes =
            GetCompatibilityInfoFromModelBytes
        ..ref.CreateEnvWithOptions = CreateEnvWithOptions
        ..ref.Session_GetEpGraphAssignmentInfo =
            Session_GetEpGraphAssignmentInfo
        ..ref.EpAssignedSubgraph_GetEpName = EpAssignedSubgraph_GetEpName
        ..ref.EpAssignedSubgraph_GetNodes = EpAssignedSubgraph_GetNodes
        ..ref.EpAssignedNode_GetName = EpAssignedNode_GetName
        ..ref.EpAssignedNode_GetDomain = EpAssignedNode_GetDomain
        ..ref.EpAssignedNode_GetOperatorType = EpAssignedNode_GetOperatorType
        ..ref.RunOptionsSetSyncStream = RunOptionsSetSyncStream
        ..ref.GetTensorElementTypeAndShapeDataReference =
            GetTensorElementTypeAndShapeDataReference
        ..ref.RunOptionsEnableProfiling = RunOptionsEnableProfiling
        ..ref.RunOptionsDisableProfiling = RunOptionsDisableProfiling
        ..ref.KernelInfoGetAttributeArray_string =
            KernelInfoGetAttributeArray_string
        ..ref.SetPerSessionThreadPoolCallbacks =
            SetPerSessionThreadPoolCallbacks
        ..ref.GetMemPatternEnabled = GetMemPatternEnabled
        ..ref.GetSessionExecutionMode = GetSessionExecutionMode
        ..ref.SessionReleaseCapturedGraph = SessionReleaseCapturedGraph
        ..ref.GetExperimentalFunction = GetExperimentalFunction
        ..ref.KernelContext_GetSyncStream = KernelContext_GetSyncStream
        ..ref.SessionOptionsSetWeightlessSourceModelBuffer =
            SessionOptionsSetWeightlessSourceModelBuffer;
}
...
final class OrtApiBase extends ffi.Struct {
  ...
  static ffi.Pointer<OrtApiBase> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Pointer<OrtApi> Function(ffi.Uint32 version)>>
        GetApi,
    required ffi.Pointer<ffi.NativeFunction<ffi.Pointer<ffi.Char> Function()>>
        GetVersionString,
  }) =>
      $allocator<OrtApiBase>()
        ..ref.GetApi = GetApi
        ..ref.GetVersionString = GetVersionString;
}
...
final class OrtCUDAProviderOptions extends ffi.Struct {
  ...
  set cudnn_conv_algo_search(OrtCudnnConvAlgoSearch value) =>
      cudnn_conv_algo_searchAsInt = value.value;
  ...
  static ffi.Pointer<OrtCUDAProviderOptions> $allocate(
    ffi.Allocator $allocator, {
    required int device_id,
    required OrtCudnnConvAlgoSearch cudnn_conv_algo_search,
    required int gpu_mem_limit,
    required int arena_extend_strategy,
    required int do_copy_in_default_stream,
    required int has_user_compute_stream,
    required ffi.Pointer<ffi.Void> user_compute_stream,
    required ffi.Pointer<OrtArenaCfg> default_memory_arena_cfg,
    required int tunable_op_enable,
    required int tunable_op_tuning_enable,
    required int tunable_op_max_tuning_duration_ms,
  }) =>
      $allocator<OrtCUDAProviderOptions>()
        ..ref.device_id = device_id
        ..ref.cudnn_conv_algo_search = cudnn_conv_algo_search
        ..ref.gpu_mem_limit = gpu_mem_limit
        ..ref.arena_extend_strategy = arena_extend_strategy
        ..ref.do_copy_in_default_stream = do_copy_in_default_stream
        ..ref.has_user_compute_stream = has_user_compute_stream
        ..ref.user_compute_stream = user_compute_stream
        ..ref.default_memory_arena_cfg = default_memory_arena_cfg
        ..ref.tunable_op_enable = tunable_op_enable
        ..ref.tunable_op_tuning_enable = tunable_op_tuning_enable
        ..ref.tunable_op_max_tuning_duration_ms =
...
final class OrtCompileApi extends ffi.Struct {
  ...
  static ffi.Pointer<OrtCompileApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<OrtModelCompilationOptions> input)>>
        ReleaseModelCompilationOptions,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtModelCompilationOptions>
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtCompileApi>()
        ..ref.ReleaseModelCompilationOptions = ReleaseModelCompilationOptions
        ..ref.CreateModelCompilationOptionsFromSessionOptions =
            CreateModelCompilationOptionsFromSessionOptions
        ..ref.ModelCompilationOptions_SetInputModelPath =
            ModelCompilationOptions_SetInputModelPath
        ..ref.ModelCompilationOptions_SetInputModelFromBuffer =
            ModelCompilationOptions_SetInputModelFromBuffer
        ..ref.ModelCompilationOptions_SetOutputModelPath =
            ModelCompilationOptions_SetOutputModelPath
        ..ref.ModelCompilationOptions_SetOutputModelExternalInitializersFile =
            ModelCompilationOptions_SetOutputModelExternalInitializersFile
        ..ref.ModelCompilationOptions_SetOutputModelBuffer =
            ModelCompilationOptions_SetOutputModelBuffer
        ..ref.ModelCompilationOptions_SetEpContextEmbedMode =
            ModelCompilationOptions_SetEpContextEmbedMode
        ..ref.CompileModel = CompileModel
        ..ref.ModelCompilationOptions_SetFlags =
            ModelCompilationOptions_SetFlags
        ..ref.ModelCompilationOptions_SetEpContextBinaryInformation =
            ModelCompilationOptions_SetEpContextBinaryInformation
        ..ref.ModelCompilationOptions_SetGraphOptimizationLevel =
            ModelCompilationOptions_SetGraphOptimizationLevel
        ..ref.ModelCompilationOptions_SetOutputModelWriteFunc =
            ModelCompilationOptions_SetOutputModelWriteFunc
        ..ref.ModelCompilationOptions_SetOutputModelGetInitializerLocationFunc =
            ModelCompilationOptions_SetOutputModelGetInitializerLocationFunc
        ..ref.ModelCompilationOptions_SetInputModel =
            ModelCompilationOptions_SetInputModel
        ..ref.ModelCompilationOptions_SetWeightlessEnabled =
            ModelCompilationOptions_SetWeightlessEnabled;
}
...
enum OrtCompileApiFlags {
  ...
  static OrtCompileApiFlags fromValue(int value) => switch (value) {
        ...
        _ =>
          throw ArgumentError('Unknown value for OrtCompileApiFlags: $value'),
      };
}
...
final class OrtCustomHandleType extends ffi.Struct {
  ...
  static ffi.Pointer<OrtCustomHandleType> $allocate(
    ffi.Allocator $allocator, {
    required int $place_holder,
  }) =>
      $allocator<OrtCustomHandleType>()..ref.__place_holder = $place_holder;
}
...
final class OrtCustomOp extends ffi.Struct {
  ...
  static ffi.Pointer<OrtCustomOp> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Void> Function(ffi.Pointer<OrtCustomOp> op,
                    ffi.Pointer<OrtApi> api, ffi.Pointer<OrtKernelInfo> info)>>
        CreateKernel,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Char> Function(ffi.Pointer<OrtCustomOp> op)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtCustomOp>,
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtCustomOp>()
        ..ref.version = version
        ..ref.CreateKernel = CreateKernel
        ..ref.GetName = GetName
        ..ref.GetExecutionProviderType = GetExecutionProviderType
        ..ref.GetInputType = GetInputType
        ..ref.GetInputTypeCount = GetInputTypeCount
        ..ref.GetOutputType = GetOutputType
        ..ref.GetOutputTypeCount = GetOutputTypeCount
        ..ref.KernelCompute = KernelCompute
        ..ref.KernelDestroy = KernelDestroy
        ..ref.GetInputCharacteristic = GetInputCharacteristic
        ..ref.GetOutputCharacteristic = GetOutputCharacteristic
        ..ref.GetInputMemoryType = GetInputMemoryType
        ..ref.GetVariadicInputMinArity = GetVariadicInputMinArity
        ..ref.GetVariadicInputHomogeneity = GetVariadicInputHomogeneity
        ..ref.GetVariadicOutputMinArity = GetVariadicOutputMinArity
        ..ref.GetVariadicOutputHomogeneity = GetVariadicOutputHomogeneity
        ..ref.CreateKernelV2 = CreateKernelV2
        ..ref.KernelComputeV2 = KernelComputeV2
        ..ref.InferOutputShapeFn = InferOutputShapeFn
        ..ref.GetStartVersion = GetStartVersion
        ..ref.GetEndVersion = GetEndVersion
        ..ref.GetMayInplace = GetMayInplace
        ..ref.ReleaseMayInplace = ReleaseMayInplace
        ..ref.GetAliasMap = GetAliasMap
        ..ref.ReleaseAliasMap = ReleaseAliasMap;
}
...
final class OrtDataTransferImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtDataTransferImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<OrtDataTransferImpl> this_ptr)>>
        Release,
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtDataTransferImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.Release = Release
        ..ref.CanCopy = CanCopy
        ..ref.CopyTensors = CopyTensors;
}
...
final class OrtEnvCreationOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtEnvCreationOptions> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required int logging_severity_level,
    required ffi.Pointer<ffi.Char> log_id,
    required OrtLoggingFunction custom_logging_function,
    required ffi.Pointer<ffi.Void> custom_logging_param,
    required ffi.Pointer<OrtThreadingOptions> threading_options,
    required ffi.Pointer<OrtKeyValuePairs> config_entries,
  }) =>
      $allocator<OrtEnvCreationOptions>()
        ..ref.version = version
        ..ref.logging_severity_level = logging_severity_level
        ..ref.log_id = log_id
        ..ref.custom_logging_function = custom_logging_function
        ..ref.custom_logging_param = custom_logging_param
        ..ref.threading_options = threading_options
        ..ref.config_entries = config_entries;
}
...
final class OrtEp extends ffi.Struct {
  ...
  static ffi.Pointer<OrtEp> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<ffi.Pointer<OrtNode>> fused_nodes,
                    ffi.Size count,
                    ffi.Pointer<ffi.Pointer<OrtNodeComputeInfo>>
                        node_compute_infos,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtEp> this_ptr,
                    ffi.Pointer<ffi.Pointer<OrtKernelRegistry>>
                        kernel_registry)>>
        GetKernelRegistry,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtEp> this_ptr,
                    ffi.Pointer<ffi.UnsignedInt> support)>>
        GetWeightlessSupport,
  }) =>
      $allocator<OrtEp>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.GetName = GetName
        ..ref.GetCapability = GetCapability
        ..ref.Compile = Compile
        ..ref.ReleaseNodeComputeInfos = ReleaseNodeComputeInfos
        ..ref.GetPreferredDataLayout = GetPreferredDataLayout
        ..ref.ShouldConvertDataLayoutForOp = ShouldConvertDataLayoutForOp
        ..ref.SetDynamicOptions = SetDynamicOptions
        ..ref.OnRunStart = OnRunStart
        ..ref.OnRunEnd = OnRunEnd
        ..ref.CreateAllocator = CreateAllocator
        ..ref.CreateSyncStreamForDevice = CreateSyncStreamForDevice
        ..ref.GetCompiledModelCompatibilityInfo =
            GetCompiledModelCompatibilityInfo
        ..ref.GetKernelRegistry = GetKernelRegistry
        ..ref.IsConcurrentRunSupported = IsConcurrentRunSupported
        ..ref.Sync = Sync
        ..ref.CreateProfiler = CreateProfiler
        ..ref.IsGraphCaptureEnabled = IsGraphCaptureEnabled
        ..ref.IsGraphCaptured = IsGraphCaptured
        ..ref.ReplayGraph = ReplayGraph
        ..ref.GetGraphCaptureNodeAssignmentPolicy =
            GetGraphCaptureNodeAssignmentPolicy
        ..ref.GetAvailableResource = GetAvailableResource
        ..ref.OnSessionInitializationEnd = OnSessionInitializationEnd
        ..ref.GetDefaultMemoryDevice = GetDefaultMemoryDevice
        ..ref.ReleaseCapturedGraph = ReleaseCapturedGraph
        ..ref.GetWeightlessSupport = GetWeightlessSupport;
}
...
final class OrtEpApi extends ffi.Struct {
  ...
  static ffi.Pointer<OrtEpApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<OrtEpDevice> input)>>
        ReleaseEpDevice,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<ffi.Char> vendor_name,
                    ffi.Pointer<OrtKeyValuePairs> metadata,
                    ffi.Pointer<ffi.Pointer<OrtHardwareDevice>>
                        hardware_device)>>
        CreateHardwareDevice,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelDef> kernel_def,
                    ffi.Size input_index, ffi.Pointer<ffi.Int> mem_type)>>
        KernelDef_GetInputMemType,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtKernelDef> kernel_def,
                    ffi.Size output_index, ffi.Pointer<ffi.Int> mem_type)>>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtSharedPrePackedWeightCache>
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<OrtKernelImpl> input)>>
        ReleaseKernelImpl,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi
            .NativeFunction<ffi.Void Function(ffi.Pointer<OrtOpSchema> input)>>
        ReleaseOpSchema,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtOpSchema> schema,
                    ffi.Pointer<ffi.Size> out)>>
        OpSchema_GetNumInputs,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtOpSchema> schema,
                    ffi.Size index, ffi.Pointer<ffi.Pointer<ffi.Char>> out)>>
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtEpApi>()
        ..ref.CreateEpDevice = CreateEpDevice
        ..ref.ReleaseEpDevice = ReleaseEpDevice
        ..ref.EpGraphSupportInfo_AddNodesToFuse =
            EpGraphSupportInfo_AddNodesToFuse
        ..ref.EpGraphSupportInfo_AddSingleNode =
            EpGraphSupportInfo_AddSingleNode
        ..ref.NodeComputeContext_NodeName = NodeComputeContext_NodeName
        ..ref.EpDevice_AddAllocatorInfo = EpDevice_AddAllocatorInfo
        ..ref.MemoryInfo_GetMemoryDevice = MemoryInfo_GetMemoryDevice
        ..ref.Value_GetMemoryDevice = Value_GetMemoryDevice
        ..ref.MemoryDevice_AreEqual = MemoryDevice_AreEqual
        ..ref.MemoryDevice_GetDeviceType = MemoryDevice_GetDeviceType
        ..ref.MemoryDevice_GetMemoryType = MemoryDevice_GetMemoryType
        ..ref.MemoryDevice_GetVendorId = MemoryDevice_GetVendorId
        ..ref.MemoryDevice_GetDeviceId = MemoryDevice_GetDeviceId
        ..ref.SyncStream_GetImpl = SyncStream_GetImpl
        ..ref.SyncStream_GetSyncId = SyncStream_GetSyncId
        ..ref.GetSyncIdForLastWaitOnSyncStream =
            GetSyncIdForLastWaitOnSyncStream
        ..ref.CreateHardwareDevice = CreateHardwareDevice
        ..ref.ReleaseHardwareDevice = ReleaseHardwareDevice
        ..ref.CreateKernelRegistry = CreateKernelRegistry
        ..ref.ReleaseKernelRegistry = ReleaseKernelRegistry
        ..ref.KernelRegistry_AddKernel = KernelRegistry_AddKernel
        ..ref.CreateKernelDefBuilder = CreateKernelDefBuilder
        ..ref.ReleaseKernelDefBuilder = ReleaseKernelDefBuilder
        ..ref.KernelDefBuilder_SetOperatorType =
            KernelDefBuilder_SetOperatorType
        ..ref.KernelDefBuilder_SetDomain = KernelDefBuilder_SetDomain
        ..ref.KernelDefBuilder_SetSinceVersion =
            KernelDefBuilder_SetSinceVersion
        ..ref.KernelDefBuilder_SetExecutionProvider =
            KernelDefBuilder_SetExecutionProvider
        ..ref.KernelDefBuilder_SetInputMemType =
            KernelDefBuilder_SetInputMemType
        ..ref.KernelDefBuilder_SetOutputMemType =
            KernelDefBuilder_SetOutputMemType
        ..ref.KernelDefBuilder_AddTypeConstraint =
            KernelDefBuilder_AddTypeConstraint
        ..ref.KernelDefBuilder_AddInputOutputAliases =
            KernelDefBuilder_AddInputOutputAliases
        ..ref.KernelDefBuilder_AddInputOutputMutableAliases =
            KernelDefBuilder_AddInputOutputMutableAliases
        ..ref.KernelDefBuilder_Build = KernelDefBuilder_Build
        ..ref.ReleaseKernelDef = ReleaseKernelDef
        ..ref.KernelDef_GetOperatorType = KernelDef_GetOperatorType
        ..ref.KernelDef_GetDomain = KernelDef_GetDomain
        ..ref.KernelDef_GetSinceVersion = KernelDef_GetSinceVersion
        ..ref.KernelDef_GetExecutionProvider = KernelDef_GetExecutionProvider
        ..ref.KernelDef_GetInputMemType = KernelDef_GetInputMemType
        ..ref.KernelDef_GetOutputMemType = KernelDef_GetOutputMemType
        ..ref.GetTensorDataType = GetTensorDataType
        ..ref.EpGraphSupportInfo_LookUpKernel = EpGraphSupportInfo_LookUpKernel
        ..ref.SharedPrePackedWeightCache_StoreWeightData =
            SharedPrePackedWeightCache_StoreWeightData
        ..ref.KernelInfo_GetEp = KernelInfo_GetEp
        ..ref.DeviceEpIncompatibilityDetails_SetDetails =
            DeviceEpIncompatibilityDetails_SetDetails
        ..ref.CreateIfKernel = CreateIfKernel
        ..ref.CreateLoopKernel = CreateLoopKernel
        ..ref.CreateScanKernel = CreateScanKernel
        ..ref.ReleaseKernelImpl = ReleaseKernelImpl
        ..ref.GetEnvConfigEntries = GetEnvConfigEntries
        ..ref.GetOpSchema = GetOpSchema
        ..ref.ReleaseOpSchema = ReleaseOpSchema
        ..ref.OpSchema_GetSinceVersion = OpSchema_GetSinceVersion
        ..ref.OpSchema_GetNumInputs = OpSchema_GetNumInputs
        ..ref.OpSchema_GetInputName = OpSchema_GetInputName
        ..ref.OpSchema_GetInputTypeConstraint = OpSchema_GetInputTypeConstraint
        ..ref.OpSchema_GetNumOutputs = OpSchema_GetNumOutputs
        ..ref.OpSchema_GetOutputName = OpSchema_GetOutputName
        ..ref.OpSchema_GetOutputTypeConstraint =
            OpSchema_GetOutputTypeConstraint
        ..ref.OpSchema_GetTypeConstraintCount = OpSchema_GetTypeConstraintCount
        ..ref.OpSchema_GetTypeConstraint = OpSchema_GetTypeConstraint
        ..ref.OpSchemaTypeConstraint_GetTypeParamName =
            OpSchemaTypeConstraint_GetTypeParamName
        ..ref.OpSchemaTypeConstraint_GetAllowedTypes =
            OpSchemaTypeConstraint_GetAllowedTypes
        ..ref.OpSchemaTypeConstraint_GetInputIndices =
            OpSchemaTypeConstraint_GetInputIndices
        ..ref.OpSchemaTypeConstraint_GetOutputIndices =
            OpSchemaTypeConstraint_GetOutputIndices
        ..ref.CreateProfilingEvent = CreateProfilingEvent
        ..ref.ReleaseProfilingEvent = ReleaseProfilingEvent
        ..ref.ProfilingEvent_GetCategory = ProfilingEvent_GetCategory
        ..ref.ProfilingEvent_GetName = ProfilingEvent_GetName
        ..ref.ProfilingEvent_GetTimestampUs = ProfilingEvent_GetTimestampUs
        ..ref.ProfilingEvent_GetDurationUs = ProfilingEvent_GetDurationUs
        ..ref.ProfilingEvent_GetArgValue = ProfilingEvent_GetArgValue
        ..ref.ProfilingEventsContainer_AddEvents =
            ProfilingEventsContainer_AddEvents
        ..ref.SessionOptionsGetWeightlessSourceModelBuffer =
            SessionOptionsGetWeightlessSourceModelBuffer;
}
...
final class OrtEpFactory extends ffi.Struct {
  ...
  static ffi.Pointer<OrtEpFactory> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtEpFactory> this_ptr,
                    ffi.Pointer<ffi.Pointer<OrtHardwareDevice>> devices,
                    ffi.Pointer<ffi.Pointer<OrtKeyValuePairs>>
                        ep_metadata_pairs,
                    ffi.Size num_devices,
                    ffi.Pointer<OrtSessionOptions> session_options,
                    ffi.Pointer<OrtLogger> logger,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Uint32 Function(ffi.Pointer<OrtEpFactory> this_ptr)>>
        GetVendorId,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Pointer<ffi.Char> Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtEpFactory> this_ptr,
                    ffi.Pointer<ffi.Pointer<OrtDataTransferImpl>>
                        data_transfer)>>
        CreateDataTransfer,
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Bool Function(ffi.Pointer<OrtEpFactory> this_ptr)>>
        IsStreamAware,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Size num_candidates,
                    ffi.Pointer<OrtSessionOptions> session_options,
                    ffi.Pointer<ffi.Size> selected_index)>>
        SelectBestModelCandidate,
  }) =>
      $allocator<OrtEpFactory>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.GetName = GetName
        ..ref.GetVendor = GetVendor
        ..ref.GetSupportedDevices = GetSupportedDevices
        ..ref.CreateEp = CreateEp
        ..ref.ReleaseEp = ReleaseEp
        ..ref.GetVendorId = GetVendorId
        ..ref.GetVersion = GetVersion
        ..ref.ValidateCompiledModelCompatibilityInfo =
            ValidateCompiledModelCompatibilityInfo
        ..ref.CreateAllocator = CreateAllocator
        ..ref.ReleaseAllocator = ReleaseAllocator
        ..ref.CreateDataTransfer = CreateDataTransfer
        ..ref.IsStreamAware = IsStreamAware
        ..ref.CreateSyncStreamForDevice = CreateSyncStreamForDevice
        ..ref.GetHardwareDeviceIncompatibilityDetails =
            GetHardwareDeviceIncompatibilityDetails
        ..ref.CreateExternalResourceImporterForDevice =
            CreateExternalResourceImporterForDevice
        ..ref.GetNumCustomOpDomains = GetNumCustomOpDomains
        ..ref.GetCustomOpDomains = GetCustomOpDomains
        ..ref.InitGraphicsInterop = InitGraphicsInterop
        ..ref.DeinitGraphicsInterop = DeinitGraphicsInterop
        ..ref.SelectBestModelCandidate = SelectBestModelCandidate;
}
...
final class OrtEpProfilerImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtEpProfilerImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtEpProfilerImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.Release = Release
        ..ref.StartProfiling = StartProfiling
        ..ref.StartEvent = StartEvent
        ..ref.StopEvent = StopEvent
        ..ref.EndProfiling = EndProfiling;
}
...
typedef OrtExperimentalFnPtr
    = ffi.Pointer<ffi.NativeFunction<OrtExperimentalFnPtrFunction>>;
typedef OrtExperimentalFnPtrFunction = ffi.Void Function();
typedef DartOrtExperimentalFnPtrFunction = void Function();
...
final class OrtExternalMemoryDescriptor extends ffi.Struct {
  ...
  set handle_type(OrtExternalMemoryHandleType value) =>
      handle_typeAsInt = value.value;
  ...
  static ffi.Pointer<OrtExternalMemoryDescriptor> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required OrtExternalMemoryHandleType handle_type,
    required ffi.Pointer<ffi.Void> native_handle,
    required int size_bytes,
    required int offset_bytes,
  }) =>
      $allocator<OrtExternalMemoryDescriptor>()
        ..ref.version = version
        ..ref.handle_type = handle_type
        ..ref.native_handle = native_handle
...
final class OrtExternalResourceImporterImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtExternalResourceImporterImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtExternalResourceImporterImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.CanImportMemory = CanImportMemory
        ..ref.ImportMemory = ImportMemory
        ..ref.ReleaseMemory = ReleaseMemory
        ..ref.CreateTensorFromMemory = CreateTensorFromMemory
        ..ref.CanImportSemaphore = CanImportSemaphore
        ..ref.ImportSemaphore = ImportSemaphore
        ..ref.ReleaseSemaphore = ReleaseSemaphore
        ..ref.WaitSemaphore = WaitSemaphore
        ..ref.SignalSemaphore = SignalSemaphore
        ..ref.Release = Release;
}
...
final class OrtExternalSemaphoreDescriptor extends ffi.Struct {
  ...
  set type(OrtExternalSemaphoreType value) => typeAsInt = value.value;

  /// < Platform-specific handle (e.g., Windows HANDLE)
  external ffi.Pointer<ffi.Void> native_handle;

  static ffi.Pointer<OrtExternalSemaphoreDescriptor> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required OrtExternalSemaphoreType type,
    required ffi.Pointer<ffi.Void> native_handle,
  }) =>
      $allocator<OrtExternalSemaphoreDescriptor>()
        ..ref.version = version
        ..ref.type = type
        ..ref.native_handle = native_handle;
}
...
final class OrtExternalTensorDescriptor extends ffi.Struct {
  ...
  set element_type(ONNXTensorElementDataType value) =>
      element_typeAsInt = value.value;
  ...
  static ffi.Pointer<OrtExternalTensorDescriptor> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required ONNXTensorElementDataType element_type,
    required ffi.Pointer<ffi.Int64> shape,
    required int rank,
    required int offset_bytes,
  }) =>
      $allocator<OrtExternalTensorDescriptor>()
        ..ref.version = version
        ..ref.element_type = element_type
        ..ref.shape = shape
        ..ref.rank = rank
        ..ref.offset_bytes = offset_bytes;
}
...
typedef OrtGetInitializerLocationFuncFunction = ffi.Pointer<OrtStatus> Function(
    ffi.Pointer<ffi.Void> state,
...
final class OrtGraphicsInteropConfig extends ffi.Struct {
  ...
  set graphics_api(OrtGraphicsApi value) => graphics_apiAsInt = value.value;
  ...
  static ffi.Pointer<OrtGraphicsInteropConfig> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required OrtGraphicsApi graphics_api,
    required ffi.Pointer<ffi.Void> command_queue,
    required ffi.Pointer<OrtKeyValuePairs> additional_options,
  }) =>
      $allocator<OrtGraphicsInteropConfig>()
        ..ref.version = version
        ..ref.graphics_api = graphics_api
        ..ref.command_queue = command_queue
        ..ref.additional_options = additional_options;
}
...
final class OrtInteropApi extends ffi.Struct {
  ...
  static ffi.Pointer<OrtInteropApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(
                    ffi.Pointer<OrtExternalSemaphoreHandle> input)>>
        ReleaseExternalSemaphoreHandle,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtInteropApi>()
        ..ref.CreateExternalResourceImporterForDevice =
            CreateExternalResourceImporterForDevice
        ..ref.ReleaseExternalResourceImporter = ReleaseExternalResourceImporter
        ..ref.CanImportMemory = CanImportMemory
        ..ref.ImportMemory = ImportMemory
        ..ref.ReleaseExternalMemoryHandle = ReleaseExternalMemoryHandle
        ..ref.CreateTensorFromMemory = CreateTensorFromMemory
        ..ref.CanImportSemaphore = CanImportSemaphore
        ..ref.ImportSemaphore = ImportSemaphore
        ..ref.ReleaseExternalSemaphoreHandle = ReleaseExternalSemaphoreHandle
        ..ref.WaitSemaphore = WaitSemaphore
        ..ref.SignalSemaphore = SignalSemaphore
        ..ref.InitGraphicsInteropForEpDevice = InitGraphicsInteropForEpDevice
        ..ref.DeinitGraphicsInteropForEpDevice =
            DeinitGraphicsInteropForEpDevice;
}
...
typedef OrtKernelCreateFuncFunction = ffi.Pointer<OrtStatus> Function(
    ffi.Pointer<ffi.Void> kernel_create_func_state,
    ffi.Pointer<OrtKernelInfo> info,
    ffi.Pointer<ffi.Pointer<OrtKernelImpl>> kernel_out);
...
final class OrtKernelImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtKernelImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required int flags,
    required ffi.Pointer<
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                ffi.Void Function(ffi.Pointer<OrtKernelImpl> this_ptr)>>
        Release,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtKernelImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.flags = flags
        ..ref.Compute = Compute
        ..ref.Release = Release
        ..ref.PrePackWeight = PrePackWeight
        ..ref.SetSharedPrePackedWeight = SetSharedPrePackedWeight;
}
...
final class OrtLoopKernelHelper extends ffi.Struct {
  ...
  static ffi.Pointer<OrtLoopKernelHelper> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtLoopKernelHelper>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.Release = Release
        ..ref.ConcatOutput = ConcatOutput;
}
...
final class OrtMIGraphXProviderOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtMIGraphXProviderOptions> $allocate(
    ffi.Allocator $allocator, {
    required int device_id,
    required int migraphx_fp16_enable,
    required int migraphx_fp8_enable,
    required int migraphx_int8_enable,
    required int migraphx_use_native_calibration_table,
    required ffi.Pointer<ffi.Char> migraphx_int8_calibration_table_name,
    required int migraphx_save_compiled_model,
    required ffi.Pointer<ffi.Char> migraphx_save_model_path,
    required int migraphx_load_compiled_model,
    required ffi.Pointer<ffi.Char> migraphx_load_model_path,
    required bool migraphx_exhaustive_tune,
    required int migraphx_mem_limit,
    required int migraphx_arena_extend_strategy,
  }) =>
      $allocator<OrtMIGraphXProviderOptions>()
        ..ref.device_id = device_id
        ..ref.migraphx_fp16_enable = migraphx_fp16_enable
        ..ref.migraphx_fp8_enable = migraphx_fp8_enable
        ..ref.migraphx_int8_enable = migraphx_int8_enable
        ..ref.migraphx_use_native_calibration_table =
            migraphx_use_native_calibration_table
        ..ref.migraphx_int8_calibration_table_name =
            migraphx_int8_calibration_table_name
        ..ref.migraphx_save_compiled_model = migraphx_save_compiled_model
        ..ref.migraphx_save_model_path = migraphx_save_model_path
        ..ref.migraphx_load_compiled_model = migraphx_load_compiled_model
        ..ref.migraphx_load_model_path = migraphx_load_model_path
        ..ref.migraphx_exhaustive_tune = migraphx_exhaustive_tune
        ..ref.migraphx_mem_limit = migraphx_mem_limit
        ..ref.migraphx_arena_extend_strategy = migraphx_arena_extend_strategy;
}
...
final class OrtModelEditorApi extends ffi.Struct {
  ...
  static ffi.Pointer<OrtModelEditorApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtSession> session,
                    ffi.Pointer<ffi.Char> domain, ffi.Pointer<ffi.Int> opset)>>
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtModelEditorApi>()
        ..ref.CreateTensorTypeInfo = CreateTensorTypeInfo
        ..ref.CreateSparseTensorTypeInfo = CreateSparseTensorTypeInfo
        ..ref.CreateMapTypeInfo = CreateMapTypeInfo
        ..ref.CreateSequenceTypeInfo = CreateSequenceTypeInfo
        ..ref.CreateOptionalTypeInfo = CreateOptionalTypeInfo
        ..ref.CreateValueInfo = CreateValueInfo
        ..ref.CreateNode = CreateNode
        ..ref.CreateGraph = CreateGraph
        ..ref.SetGraphInputs = SetGraphInputs
        ..ref.SetGraphOutputs = SetGraphOutputs
        ..ref.AddInitializerToGraph = AddInitializerToGraph
        ..ref.AddNodeToGraph = AddNodeToGraph
        ..ref.CreateModel = CreateModel
        ..ref.AddGraphToModel = AddGraphToModel
        ..ref.CreateSessionFromModel = CreateSessionFromModel
        ..ref.CreateModelEditorSession = CreateModelEditorSession
        ..ref.CreateModelEditorSessionFromArray =
            CreateModelEditorSessionFromArray
        ..ref.SessionGetOpsetForDomain = SessionGetOpsetForDomain
        ..ref.ApplyModelToModelEditorSession = ApplyModelToModelEditorSession
        ..ref.FinalizeModelEditorSession = FinalizeModelEditorSession;
}
...
final class OrtNodeComputeInfo extends ffi.Struct {
  ...
  static ffi.Pointer<OrtNodeComputeInfo> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtNodeComputeInfo>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.CreateState = CreateState
        ..ref.Compute = Compute
        ..ref.ReleaseState = ReleaseState;
}
...
final class OrtNodeFusionOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtNodeFusionOptions> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required bool drop_constant_initializers,
  }) =>
      $allocator<OrtNodeFusionOptions>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.drop_constant_initializers = drop_constant_initializers;
}
...
final class OrtOpenVINOProviderOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtOpenVINOProviderOptions> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<ffi.Char> device_type,
    required int enable_npu_fast_compile,
    required ffi.Pointer<ffi.Char> device_id,
    required int num_of_threads,
    required ffi.Pointer<ffi.Char> cache_dir,
    required ffi.Pointer<ffi.Void> context,
    required int enable_opencl_throttling,
    required int enable_dynamic_shapes,
  }) =>
      $allocator<OrtOpenVINOProviderOptions>()
        ..ref.device_type = device_type
        ..ref.enable_npu_fast_compile = enable_npu_fast_compile
        ..ref.device_id = device_id
        ..ref.num_of_threads = num_of_threads
        ..ref.cache_dir = cache_dir
        ..ref.context = context
        ..ref.enable_opencl_throttling = enable_opencl_throttling
        ..ref.enable_dynamic_shapes = enable_dynamic_shapes;
}
...
final class OrtROCMProviderOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtROCMProviderOptions> $allocate(
    ffi.Allocator $allocator, {
    required int device_id,
    required int miopen_conv_exhaustive_search,
    required int gpu_mem_limit,
    required int arena_extend_strategy,
    required int do_copy_in_default_stream,
    required int has_user_compute_stream,
    required ffi.Pointer<ffi.Void> user_compute_stream,
    required ffi.Pointer<OrtArenaCfg> default_memory_arena_cfg,
    required int enable_hip_graph,
    required int tunable_op_enable,
    required int tunable_op_tuning_enable,
    required int tunable_op_max_tuning_duration_ms,
  }) =>
      $allocator<OrtROCMProviderOptions>()
        ..ref.device_id = device_id
        ..ref.miopen_conv_exhaustive_search = miopen_conv_exhaustive_search
        ..ref.gpu_mem_limit = gpu_mem_limit
        ..ref.arena_extend_strategy = arena_extend_strategy
        ..ref.do_copy_in_default_stream = do_copy_in_default_stream
        ..ref.has_user_compute_stream = has_user_compute_stream
        ..ref.user_compute_stream = user_compute_stream
        ..ref.default_memory_arena_cfg = default_memory_arena_cfg
        ..ref.enable_hip_graph = enable_hip_graph
        ..ref.tunable_op_enable = tunable_op_enable
        ..ref.tunable_op_tuning_enable = tunable_op_tuning_enable
        ..ref.tunable_op_max_tuning_duration_ms =
            tunable_op_max_tuning_duration_ms;
...
final class OrtScanKernelHelper extends ffi.Struct {
  ...
  static ffi.Pointer<OrtScanKernelHelper> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
...
final class OrtSyncNotificationImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtSyncNotificationImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtSyncNotificationImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.Release = Release
        ..ref.Activate = Activate
        ..ref.WaitOnDevice = WaitOnDevice
        ..ref.WaitOnHost = WaitOnHost;
}
...
final class OrtSyncStreamImpl extends ffi.Struct {
  ...
  static ffi.Pointer<OrtSyncStreamImpl> $allocate(
    ffi.Allocator $allocator, {
    required int ort_version_supported,
    required ffi.Pointer<
            ffi.NativeFunction<
    ...
    required ffi.Pointer<
      ...
      $allocator<OrtSyncStreamImpl>()
        ..ref.ort_version_supported = ort_version_supported
        ..ref.Release = Release
        ..ref.GetHandle = GetHandle
        ..ref.CreateNotification = CreateNotification
        ..ref.Flush = Flush
        ..ref.OnSessionRunEnd = OnSessionRunEnd;
}
...
final class OrtTensorRTProviderOptions extends ffi.Struct {
  ...
  static ffi.Pointer<OrtTensorRTProviderOptions> $allocate(
    ffi.Allocator $allocator, {
    required int device_id,
    required int has_user_compute_stream,
    required ffi.Pointer<ffi.Void> user_compute_stream,
    required int trt_max_partition_iterations,
    required int trt_min_subgraph_size,
    required int trt_max_workspace_size,
    required int trt_fp16_enable,
    required int trt_int8_enable,
    required ffi.Pointer<ffi.Char> trt_int8_calibration_table_name,
    required int trt_int8_use_native_calibration_table,
    required int trt_dla_enable,
    required int trt_dla_core,
    required int trt_dump_subgraphs,
    required int trt_engine_cache_enable,
    required ffi.Pointer<ffi.Char> trt_engine_cache_path,
    required int trt_engine_decryption_enable,
    required ffi.Pointer<ffi.Char> trt_engine_decryption_lib_path,
    required int trt_force_sequential_engine_build,
  }) =>
      $allocator<OrtTensorRTProviderOptions>()
        ..ref.device_id = device_id
        ..ref.has_user_compute_stream = has_user_compute_stream
        ..ref.user_compute_stream = user_compute_stream
        ..ref.trt_max_partition_iterations = trt_max_partition_iterations
        ..ref.trt_min_subgraph_size = trt_min_subgraph_size
        ..ref.trt_max_workspace_size = trt_max_workspace_size
        ..ref.trt_fp16_enable = trt_fp16_enable
        ..ref.trt_int8_enable = trt_int8_enable
        ..ref.trt_int8_calibration_table_name = trt_int8_calibration_table_name
        ..ref.trt_int8_use_native_calibration_table =
            trt_int8_use_native_calibration_table
        ..ref.trt_dla_enable = trt_dla_enable
        ..ref.trt_dla_core = trt_dla_core
        ..ref.trt_dump_subgraphs = trt_dump_subgraphs
        ..ref.trt_engine_cache_enable = trt_engine_cache_enable
        ..ref.trt_engine_cache_path = trt_engine_cache_path
        ..ref.trt_engine_decryption_enable = trt_engine_decryption_enable
        ..ref.trt_engine_decryption_lib_path = trt_engine_decryption_lib_path
        ..ref.trt_force_sequential_engine_build =
...
final class OrtThreadPoolCallbacksConfig extends ffi.Struct {
  ...
  static ffi.Pointer<OrtThreadPoolCallbacksConfig> $allocate(
    ffi.Allocator $allocator, {
    required int version,
    required OrtThreadPoolWorkEnqueueFn on_enqueue,
    required OrtThreadPoolWorkStartFn on_start_work,
    required OrtThreadPoolWorkStopFn on_stop_work,
    required OrtThreadPoolWorkAbandonFn on_abandon,
    required ffi.Pointer<ffi.Void> user_context,
  }) =>
      $allocator<OrtThreadPoolCallbacksConfig>()
        ..ref.version = version
        ..ref.on_enqueue = on_enqueue
        ..ref.on_start_work = on_start_work
        ..ref.on_stop_work = on_stop_work
        ..ref.on_abandon = on_abandon
        ..ref.user_context = user_context;
}
...
typedef OrtThreadPoolWorkAbandonFnFunction = ffi.Void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
typedef DartOrtThreadPoolWorkAbandonFnFunction = void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
...
typedef OrtThreadPoolWorkEnqueueFnFunction = ffi.Pointer<ffi.Void> Function(
...
typedef OrtThreadPoolWorkStartFnFunction = ffi.Void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
typedef DartOrtThreadPoolWorkStartFnFunction = void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
...
typedef OrtThreadPoolWorkStopFnFunction = ffi.Void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
typedef DartOrtThreadPoolWorkStopFnFunction = void Function(
    ffi.Pointer<ffi.Void> user_context, ffi.Pointer<ffi.Void> enqueue_data);
      ...
      ffi.NativeFunction<
          OrtStatusPtr Function(
              ...
              ffi.Pointer<ffi.Pointer<OrtTensorTypeAndShapeInfo>>
                  parameter_type_and_shape)>> GetParameterTypeAndShape;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          OrtStatusPtr Function(
              ffi.Pointer<OrtCheckpointState> checkpoint_state,
              ffi.Pointer<ffi.Char> parameter_name,
              ffi.Pointer<OrtValue> parameter)>> UpdateParameter;
  ...
  external ffi.Pointer<
      ffi.NativeFunction<
          OrtStatusPtr Function(
              ...
              ffi.Pointer<ffi.Char> parameter_name,
              ffi.Pointer<OrtAllocator> allocator,
              ffi.Pointer<ffi.Pointer<OrtValue>> parameter)>> GetParameter;

  static ffi.Pointer<OrtTrainingApi> $allocate(
    ffi.Allocator $allocator, {
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtCheckpointState> checkpoint_state,
                    ffi.Pointer<ffi.Char> checkpoint_path,
                    ffi.Bool include_optimizer_state)>>
        SaveCheckpoint,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtTrainingSession> sess,
                    ffi.Float learning_rate)>>
        SetLearningRate,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtTrainingSession> sess,
                    ffi.Pointer<ffi.Float> learning_rate)>>
        GetLearningRate,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtTrainingSession> sess,
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(ffi.Pointer<OrtTrainingSession> sess,
                    ffi.Pointer<ffi.Size> out, ffi.Bool trainable_only)>>
        GetParametersSize,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<ffi.Char> property_name,
                    ffi.UnsignedInt property_type,
                    ffi.Pointer<ffi.Void> property_value)>>
        AddProperty,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<OrtAllocator> allocator,
                    ffi.Pointer<ffi.UnsignedInt> property_type,
                    ffi.Pointer<ffi.Pointer<ffi.Void>> property_value)>>
        GetProperty,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
    ...
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ffi.Pointer<OrtCheckpointState> checkpoint_state,
                    ffi.Pointer<ffi.Char> parameter_name,
                    ffi.Pointer<OrtValue> parameter)>>
        UpdateParameter,
    required ffi.Pointer<
            ffi.NativeFunction<
                OrtStatusPtr Function(
                    ...
                    ffi.Pointer<ffi.Char> parameter_name,
                    ffi.Pointer<OrtAllocator> allocator,
                    ffi.Pointer<ffi.Pointer<OrtValue>> parameter)>>
        GetParameter,
  }) =>
      $allocator<OrtTrainingApi>()
        ..ref.LoadCheckpoint = LoadCheckpoint
        ..ref.SaveCheckpoint = SaveCheckpoint
        ..ref.CreateTrainingSession = CreateTrainingSession
        ..ref.CreateTrainingSessionFromBuffer = CreateTrainingSessionFromBuffer
        ..ref.TrainingSessionGetTrainingModelOutputCount =
            TrainingSessionGetTrainingModelOutputCount
        ..ref.TrainingSessionGetEvalModelOutputCount =
            TrainingSessionGetEvalModelOutputCount
        ..ref.TrainingSessionGetTrainingModelOutputName =
            TrainingSessionGetTrainingModelOutputName
        ..ref.TrainingSessionGetEvalModelOutputName =
            TrainingSessionGetEvalModelOutputName
        ..ref.LazyResetGrad = LazyResetGrad
        ..ref.TrainStep = TrainStep
        ..ref.EvalStep = EvalStep
        ..ref.SetLearningRate = SetLearningRate
        ..ref.GetLearningRate = GetLearningRate
        ..ref.OptimizerStep = OptimizerStep
        ..ref.RegisterLinearLRScheduler = RegisterLinearLRScheduler
        ..ref.SchedulerStep = SchedulerStep
        ..ref.GetParametersSize = GetParametersSize
        ..ref.CopyParametersToBuffer = CopyParametersToBuffer
        ..ref.CopyBufferToParameters = CopyBufferToParameters
        ..ref.ReleaseTrainingSession = ReleaseTrainingSession
        ..ref.ReleaseCheckpointState = ReleaseCheckpointState
        ..ref.ExportModelForInferencing = ExportModelForInferencing
        ..ref.SetSeed = SetSeed
        ..ref.TrainingSessionGetTrainingModelInputCount =
            TrainingSessionGetTrainingModelInputCount
        ..ref.TrainingSessionGetEvalModelInputCount =
            TrainingSessionGetEvalModelInputCount
        ..ref.TrainingSessionGetTrainingModelInputName =
            TrainingSessionGetTrainingModelInputName
        ..ref.TrainingSessionGetEvalModelInputName =
            TrainingSessionGetEvalModelInputName
        ..ref.AddProperty = AddProperty
        ..ref.GetProperty = GetProperty
        ..ref.LoadCheckpointFromBuffer = LoadCheckpointFromBuffer
        ..ref.GetParameterTypeAndShape = GetParameterTypeAndShape
        ..ref.UpdateParameter = UpdateParameter
        ..ref.GetParameter = GetParameter;
}
...
typedef OrtWriteBufferFuncFunction = ffi.Pointer<OrtStatus> Function(
    ffi.Pointer<ffi.Void> state,
    ffi.Pointer<ffi.Void> buffer,
    ffi.Size buffer_num_bytes);
typedef DartOrtWriteBufferFuncFunction = ffi.Pointer<OrtStatus> Function(
    ffi.Pointer<ffi.Void> state,
    ffi.Pointer<ffi.Void> buffer,
...
const String kCOREML_CACHE_KEY = 'COREML_CACHE_KEY';

const String kCoremlProviderOption_AllowLowPrecisionAccumulationOnGPU =
    'AllowLowPrecisionAccumulationOnGPU';

const String kCoremlProviderOption_EnableOnSubgraphs = 'EnableOnSubgraphs';

const String kCoremlProviderOption_MLComputeUnits = 'MLComputeUnits';

const String kCoremlProviderOption_ModelCacheDirectory = 'ModelCacheDirectory';

const String kCoremlProviderOption_ModelFormat = 'ModelFormat';

const String kCoremlProviderOption_ProfileComputePlan = 'ProfileComputePlan';

const String kCoremlProviderOption_RequireStaticInputShapes =
    'RequireStaticInputShapes';

const String kCoremlProviderOption_SpecializationStrategy =
