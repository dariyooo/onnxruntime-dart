...
///
/// Installed as a file by onnxruntime_ep_qnn_binaries, found by asking the loader where the
/// asset landed, and registered with the environment. The asset id has to be a
/// compile-time constant, which is why this lives in the provider's own
/// package: only it can name its own asset.
library;
...
/// Registers the provider under `qnn`, and reports whether it was there.
///
