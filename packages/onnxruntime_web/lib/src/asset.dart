...
const ortLoaderUrl =
    'assets/packages/onnxruntime_web/assets/ort-wasm-simd-threaded.mjs';

/// The runtime itself, fetched by the loader.
const ortWasmUrl =
    'assets/packages/onnxruntime_web/assets/ort-wasm-simd-threaded.wasm';

/// Which build this package carries, as named by the build matrix.
const ortWebBuild = 'web-wasm';
