...
class CompiledApp {
  ...
  async instantiate(additionalImports,
    ...
    const dart2wasm = {
      ...
      _1305: (x0,x1) => x0.appendChild(x1),
      _1306: (x0,x1) => x0.createElement(x1),
      _1307: (x0,x1) => x0.item(x1),
      _1308: x0 => x0.remove(),
      ...
      _1328: x0 => new FinalizationRegistry(x0),
      _1329: (x0,x1,x2,x3) => x0.register(x1,x2,x3),
      _1331: (x0,x1) => x0.unregister(x1),
      _1333: () => globalThis.WeakRef,
      _1334: () => globalThis.FinalizationRegistry,
      ...
      _1380: (m) => import(m),
      _1411: x0 => new Array(x0),
      _1413: x0 => x0.length,
      _1415: (x0,x1) => x0[x1],
      _1416: (x0,x1,x2) => { x0[x1] = x2 },
      _1419: (x0,x1,x2) => new DataView(x0,x1,x2),
      _1421: x0 => new Int8Array(x0),
      _1422: (x0,x1,x2) => new Uint8Array(x0,x1,x2),
      _1424: x0 => new Uint8ClampedArray(x0),
      _1426: x0 => new Int16Array(x0),
      _1428: x0 => new Uint16Array(x0),
      _1430: x0 => new Int32Array(x0),
      _1432: x0 => new Uint32Array(x0),
      _1434: x0 => new Float32Array(x0),
      _1436: x0 => new Float64Array(x0),
      _1460: x0 => x0.random(),
      _1463: () => globalThis.Math,
      _1476: (ms, c) =>
      ...
      _1548: (o, p) => o[p],
      _1549: (o, p, v) => o[p] = v,
      _1552: (x0,x1) => { x0.currentContext = x1 },
      _1553: (x0,x1) => x0.webnnCreateMLContext(x1),
      _1554: (x0,x1,x2) => x0.webnnRegisterMLContext(x1,x2),
      _1555: (x0,x1) => x0.webnnInit(x1),
      _1556: () => globalThis.navigator,
      _1557: (x0,x1) => x0.createContext(x1),
      _1558: (module,f) => finalizeWrapper(f, function() { return module.exports._1558(f,arguments.length) }),
      ...
      _1566: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1566(f,arguments.length,x0,x1) }),
      _1567: (module,f) => finalizeWrapper(f, function(x0) { return module.exports._1567(f,arguments.length,x0) }),
      _1568: x0 => x0.asyncInit(),
      _1569: (x0,x1,x2,x3) => x0._OrtCreateSession(x1,x2,x3),
      _1570: (x0,x1) => x0._OrtReleaseSessionOptions(x1),
      _1571: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => x0._OrtRun(x1,x2,x3,x4,x5,x6,x7,x8),
      _1572: (x0,x1,x2,x3,x4,x5) => x0._OrtAppendExecutionProvider(x1,x2,x3,x4,x5),
      _1573: (x0,x1,x2) => x0._OrtInit(x1,x2),
      _1574: (x0,x1,x2,x3) => x0._OrtCreateSession(x1,x2,x3),
      _1575: (x0,x1,x2,x3,x4,x5,x6,x7,x8,x9,x10) => x0._OrtCreateSessionOptions(x1,x2,x3,x4,x5,x6,x7,x8,x9,x10),
      _1576: (x0,x1,x2,x3) => x0._OrtAddSessionConfigEntry(x1,x2,x3),
      _1577: (x0,x1,x2,x3) => x0._OrtAddFreeDimensionOverride(x1,x2,x3),
      _1578: (x0,x1,x2,x3,x4,x5) => x0._OrtAppendExecutionProvider(x1,x2,x3,x4,x5),
      _1579: (x0,x1) => x0._OrtReleaseSession(x1),
      _1580: (x0,x1,x2,x3) => x0._OrtGetInputOutputCount(x1,x2,x3),
      _1581: (x0,x1,x2,x3,x4) => x0._OrtGetInputOutputMetadata(x1,x2,x3,x4),
      _1582: (x0,x1) => x0._OrtFree(x1),
      _1583: (x0,x1,x2,x3,x4,x5,x6) => x0._OrtCreateTensor(x1,x2,x3,x4,x5,x6),
      _1584: (x0,x1,x2,x3,x4,x5) => x0._OrtGetTensorData(x1,x2,x3,x4,x5),
      _1585: (x0,x1) => x0._OrtReleaseTensor(x1),
      _1586: (x0,x1,x2,x3,x4) => x0._OrtCreateRunOptions(x1,x2,x3,x4),
      _1588: (x0,x1) => x0._OrtReleaseRunOptions(x1),
      _1589: (x0,x1,x2,x3,x4,x5,x6,x7,x8) => x0._OrtRun(x1,x2,x3,x4,x5,x6,x7,x8),
      _1597: () => new XMLHttpRequest(),
      _1598: (x0,x1,x2,x3) => x0.open(x1,x2,x3),
      _1602: x0 => x0.send(),
      ...
      _1619: () => new FileReader(),
      _1620: (x0,x1) => x0.readAsArrayBuffer(x1),
      _1621: () => new AbortController(),
      _1622: x0 => x0.abort(),
      _1623: (x0,x1,x2,x3,x4,x5) => ({method: x0,headers: x1,body: x2,credentials: x3,redirect: x4,signal: x5}),
      _1624: (x0,x1) => globalThis.fetch(x0,x1),
      _1625: (x0,x1) => x0.get(x1),
      _1626: (module,f) => finalizeWrapper(f, function(x0,x1,x2) { return module.exports._1626(f,arguments.length,x0,x1,x2) }),
      _1627: (x0,x1) => x0.forEach(x1),
      _1628: x0 => x0.getReader(),
      _1629: x0 => x0.cancel(),
      _1630: x0 => x0.read(),
      _1631: (module,f) => finalizeWrapper(f, function(x0,x1) { return module.exports._1631(f,arguments.length,x0,x1) }),
      ...
      _1720: (x0,x1) => x0._malloc(x1),
      _1721: (x0,x1) => x0._free(x1),
      _1722: (x0,x1) => x0.UTF8ToString(x1),
      _1723: (x0,x1,x2,x3) => x0.stringToUTF8(x1,x2,x3),
      _1724: (x0,x1) => x0.lengthBytesUTF8(x1),
      _1725: (x0,x1,x2) => x0.getValue(x1,x2),
      _1726: (x0,x1,x2,x3) => x0.setValue(x1,x2,x3),
      _1727: x0 => x0.HEAPU8,
      _1728: (x0,x1,x2) => x0._OrtGetLastError(x1,x2),
      _1791: (x0,x1) => { x0.responseType = x1 },
      _1792: x0 => x0.response,
      _2797: (x0,x1) => { x0.accept = x1 },
      _2811: x0 => x0.files,
      _2837: (x0,x1) => { x0.multiple = x1 },
      _2855: (x0,x1) => { x0.type = x1 },
      ...
      _8723: x0 => x0.body,
      _12351: x0 => x0.name,
      _13097: () => globalThis.console,
      _13136: (x0,x1) => x0.error(x1),
